...
describe("create user", () => {
  ...
  it("should return error with status 400 if password is not a secure password", async () => {
  ...
  it("should return error with status 400 if a user with same email exists", async () => {
    const db = {
      findUserByEmail: jest.fn(() => {
        const err = null;
